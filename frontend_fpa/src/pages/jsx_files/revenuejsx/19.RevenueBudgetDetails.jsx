...
import "../../css_files/revenuecss/19.RevenueBudgetDetails.css";

const RevenueBudgetDetails = () => {
    const navigate = useNavigate();
    const [isImportModalOpen, setIsImportModalOpen] = useState(false);

    // Data sampel untuk tabel detail REVENUE Budget
    const detailsData = [
        { code: "BGT-REV-001", desc: "Target Pendapatan Jasa", year: "2025", month: "Jan", branch: "Pusat", coa: "40001100", amount: "300,000,000" },
        { code: "BGT-REV-002", desc: "Target Penjualan Produk", year: "2025", month: "Jan", branch: "Pusat", coa: "40001200", amount: "150,000,000" },
    ];

    return (
        <div className="dashboard-container">
            {/* Sidebar Navigasi Kiri (Akun Admin) */}
            ...
            <main className="main-area">
                ...
                {/* Area Isi REVENUE Budget Details */}
                <section className="content-section">
                    <div className="page-title-banner">
                        <h2>REVENUE Budget Details</h2>
                    </div>
                    ...
                    <div className="action-buttons-row">
                        <button className="action-btn-custom" onClick={() => navigate("/revenue/budget")}>
                            Budget REVENUE
                        </button>
                        <button className="action-btn-custom" onClick={() => setIsImportModalOpen(true)}>
                            Import
                        </button>
                        <button className="action-btn-custom delete-btn" onClick={() => alert("Hapus data budget terpilih")}>
                            Delete Budget
                        </button>
                    </div>
                </section>
...
export default RevenueBudgetDetails;