...
import "../../css_files/revenuecss/16.RevenueActual.css";

const RevenueActual = () => {
    const navigate = useNavigate();

    // Data sampel untuk tabel bulanan REVENUE Actual
    const tableData = [
    ...
    return (
        <div className="dashboard-container">
            ...
            <main className="main-area">
                ...
                {/* Area Isi REVENUE Actual */}
                <section className="content-section">
                    <div className="page-title-banner">
                        <h2>REVENUE Actual</h2>
                    </div>
                    ...
                    <div className="actual-top-content">
                        ...
                        <div className="action-panel">
                            ...
                            <button className="action-btn update-actual-btn" onClick={() => navigate("/revenue/actual/details")}>
                                Update Actual
                            </button>
                        </div>
                    </div>
