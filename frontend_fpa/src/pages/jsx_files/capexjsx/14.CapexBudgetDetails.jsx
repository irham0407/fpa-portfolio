...
import "../../css_files/capexcss/14.CapexBudgetDetails.css";

const CapexBudgetDetails = () => {
    const navigate = useNavigate();
    const [isImportModalOpen, setIsImportModalOpen] = useState(false);

    const detailsData = [
        { code: "CBGT-001", desc: "Alokasi Mesin Produksi", year: "2025", month: "Jan", branch: "Pusat", coa: "12001100", amount: "500,000,000" },
        { code: "CBGT-002", desc: "Alokasi Renovasi Gedung", year: "2025", month: "Jan", branch: "Pusat", coa: "12001200", amount: "200,000,000" },
    ];
            ...
            <main className="main-area">
                ...
                <section className="content-section">
                    ...
                    <div className="action-buttons-row">
                        <button className="action-btn-custom" onClick={() => navigate("/capex/budget")}>
                            Budget CAPEX
                        </button>
...
export default CapexBudgetDetails;