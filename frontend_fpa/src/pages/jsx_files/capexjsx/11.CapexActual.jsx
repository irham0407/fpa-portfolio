...
import "../../css_files/capexcss/11.CapexActual.css";
        ...
        <div className="dashboard-container">
            ...
            <main className="main-area">
                ...
                <section className="content-section">
                    ...
                    <div className="top-analytics-row">
                        ...
                        <div className="controls-column">
                            <div className="dropdown-year-box">2025 ▼</div>
                            <button className="action-btn select-coa-btn">Select COA</button>
                            <button className="action-btn update-actual-btn" onClick={() => navigate("/capex/actual/details")}>
                                Update Actual
                            </button>
                        </div>
                    </div>
