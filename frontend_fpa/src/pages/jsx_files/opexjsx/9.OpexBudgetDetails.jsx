...
import "../../css_files/opexcss/9.OpexBudgetDetails.css";

const OpexBudgetDetails = () => {
    const navigate = useNavigate();
    const [isImportModalOpen, setIsImportModalOpen] = useState(false);

    // Data sampel untuk tabel detail OPEX Budget
    const detailsData = [
        { code: "BGT-001", desc: "Alokasi Gaji Karyawan", year: "2025", month: "Jan", branch: "Pusat", coa: "50001100", amount: "300,000,000" },
        { code: "BGT-002", desc: "Alokasi Sewa Gedung", year: "2025", month: "Jan", branch: "Pusat", coa: "50001200", amount: "150,000,000" },
    ];
    ...
    return (
        <div className="dashboard-container">
            ...
            <main className="main-area">
                ...
                {/* Area Isi OPEX Budget Details */}
                <section className="content-section">
                    <div className="page-title-banner">
                        <h2>OPEX Budget Details</h2>
                    </div>
                    ...
                    <div className="action-buttons-row">
                        <button className="action-btn-custom" onClick={() => navigate("/opex/budget")}>
                            Budget OPEX
                        </button>
...
export default OpexBudgetDetails;