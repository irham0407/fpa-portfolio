...
import "../../css_files/opexcss/8.OpexBudget.css";

const OpexBudget = () => {
    const navigate = useNavigate();

    // Data sampel untuk tabel bulanan OPEX Budget
    const tableData = [
            ...
            <main className="main-area">
                ...
                <section className="content-section">
                    ...
                    <div className="budget-action-row">
                        ...
                        <button className="action-btn import-budget-btn" onClick={() => navigate("/opex/budget/details")}>
                            Import Budget
                        </button>
                    </div>
